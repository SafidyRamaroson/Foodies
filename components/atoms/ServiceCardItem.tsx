...
export function ServiceCardItem({
    ...
    return (
        <div className="flex flex-col items-center gap-1 p-8 border-2 hover:shadow-[0_10px_25px_0px_hsl(0,0%,0%,0.15)] hover:transition-shadow hover:duration-300 hover:ease-out hover:border-[0px] rounded-3xl">
